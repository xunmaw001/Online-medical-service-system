				...
				<div class="layui-row">
					...
					<div class="layui-col-md7" style="padding-left: 20px;">
						...
						<div v-if="detail.alllimittimes" class="detail-item">
							...
							<span>检查项目：</span>
							<span class="desc">
								{{detail.jianchaxiangmu}}
							</span>
						</div>
																								<div class="detail-item">
							<span>检查结果：</span>
							<span class="desc">
								{{detail.jianchajieguo}}
							</span>
						</div>
																								<div class="detail-item">
							<span>药单：</span>
							...
							<span>病例附件：</span>
							<span class="desc">
								<a download="binglifujian" :href="detail.binglifujian">点击下载</a>
							</span>
						</div>
			...
			var vue = new Vue({
				...
				methods: {
					...
					onAcrossTap(acrossTable){
						localStorage.setItem('crossTable',`yonghubingli`);
