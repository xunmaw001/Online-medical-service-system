...
<body>
												...
												<div class="custom-control custom-checkbox">
													...
													<label class="custom-control-label" for="select-all"></label>
																													...
																													<th>图片</th>
																																																			...
																																																			<th onclick="sort('changjia')">厂家<i id="changjiaIcon" class="fa fa-sort"></i></th>
	...
	<script>
			...
			row.appendChild(checkbox)
				  ...
				  tupianCell.appendChild(tupianImg);
									...
									row.appendChild(guigeCell);
				            				var changjiaCell  = document.createElement('td');

												 changjiaCell.innerHTML = item.changjia;

				
									row.appendChild(changjiaCell);
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"yaopin");
